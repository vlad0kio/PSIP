...
TEMPLATES = [
    {
        ...
        'APP_DIRS': True,  # Ищем шаблоны в папках templates внутри приложений
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'psip.wsgi.application'
...
# Для сбора статических файлов в продакшене
